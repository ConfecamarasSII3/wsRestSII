...
if (isset($_SESSION["generales"]) && isset($_SESSION["generales"]["pathabsoluto"])) {
    ...
    require_once ('components74/vendor/autoload.php');
}
...
class funcionesGenerales {
    ...
    public static function encontrarTamanoEmpresa($mysqli, $fecha, $valor, $personal) {
        $smmlv = \funcionesGenerales::localizarSmmlv($fecha, $mysqli);
    ...
    public static function enviarEmail($servmail, $portsmtp, $requiautenticacion, $tipoencripcion, $ctaremi, $passremi, $remiemail, $nombreremi, $destino, $asunto, $mensaje, $attach = array(), $ctrmasivo = 'no', $ctralterno = 'si', $confirmacionlectura = 'no', $cc = '') {
        if (defined('ENVIAR_EMAILS') && ENVIAR_EMAILS === 'N') {
            ...
            \logApi::general2('email', __FUNCTION__, 'No se están enviando emails pues el parámnetro ENVIAR_EMAILS está en N');
            return true;
        }
        if (substr(PHP_VERSION, 0, 1) == '7' || substr(PHP_VERSION, 0, 1) == '8') {
            return \funcionesgenerales::enviarEmailPhp7($servmail, $portsmtp, $requiautenticacion, $tipoencripcion, $ctaremi, $passremi, $remiemail, $nombreremi, $destino, $asunto, $mensaje, $attach, $ctrmasivo, $ctralterno, $confirmacionlectura, $cc);
        }
...
//
                ...
                if ($iexp == 1) {
                    ...
                    if (!empty($reps)) {
                        foreach ($reps as $rep) {
                            ...
                            $retorno["replegal"][$i]["nombrereplegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("nombrereplegal")->item(0)->textContent)));
                            $retorno["replegal"][$i]["nombre1replegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("nombre1replegal")->item(0)->textContent)));
                            $retorno["replegal"][$i]["nombre2replegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("nombre2replegal")->item(0)->textContent)));
                            $retorno["replegal"][$i]["apellido1replegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("apellido1replegal")->item(0)->textContent)));
                            $retorno["replegal"][$i]["apellido2replegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("apellido2replegal")->item(0)->textContent)));
                            ...
                            if (isset($rep->getElementsByTagName("emailreplegal")->item(0)->textContent)) {
                                $retorno["replegal"][$i]["emailreplegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("emailreplegal")->item(0)->textContent)));
                            }
                            if (isset($rep->getElementsByTagName("celularreplegal")->item(0)->textContent)) {
                                $retorno["replegal"][$i]["celularreplegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("emailreplegal")->item(0)->textContent)));
                            }
                            $retorno["replegal"][$i]["cargoreplegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("cargoreplegal")->item(0)->textContent)));
                            $retorno["replegal"][$i]["vinculoreplegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("vinculoreplegal")->item(0)->textContent)));
                            $retorno["replegal"][$i]["libroreplegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("libroreplegal")->item(0)->textContent)));
                            $retorno["replegal"][$i]["inscripcionreplegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("inscripcionreplegal")->item(0)->textContent)));
                            $retorno["replegal"][$i]["fechareplegal"] = (\funcionesGenerales::restaurarEspeciales(trim($rep->getElementsByTagName("fechareplegal")->item(0)->textContent)));
                        }
                    }
                    ...
                    if (!empty($socs)) {
                        foreach ($socs as $soc) {
                            if (isset($soc->getElementsByTagName("idtipoidentificacionotros")->item(0)->textContent)) {
                                ...
                                $retorno["vinculos"][$i]["nombreotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("nombreotros")->item(0)->textContent)));
                                ...
                                if (isset($soc->getElementsByTagName("apellido1otros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["apellido1otros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("apellido1otros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("apellido2otros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["apellido2otros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("apellido2otros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("nombre1otros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["nombre1otros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("nombre1otros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("nombre2otros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["nombre2otros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("nombre2otros")->item(0)->textContent)));
                                }

                                if (isset($soc->getElementsByTagName("emailotros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["emailotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("emailotros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("celularotros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["celularotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("celularotros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("idcarotros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["idcargootros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("idcarotros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("cargootros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["cargootros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("cargootros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("vinculootros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["vinculootros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("vinculootros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("cargootros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["cargootros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("cargootros")->item(0)->textContent)));
                                }
                                ...
                                if (isset($soc->getElementsByTagName("numtarpotros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["numtarprofotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("numtarpotros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("idclaseemp")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["idclaseemp"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("idclaseemp")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("numidemp")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["numidemp"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("numidemp")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("idvindian")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["idvindian"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("idvindian")->item(0)->textContent)));
                                }
                                ...
                                if (isset($soc->getElementsByTagName("librootros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["librootros"] = (restaurarEspeciales(trim($soc->getElementsByTagName("librootros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("inscripcionotros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["inscripcionotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("inscripcionotros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("dupliotros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["dupliotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("dupliotros")->item(0)->textContent)));
                                } else {
                                    $retorno["vinculos"][$i]["dupliotros"] = '';
                                }

                                if (isset($soc->getElementsByTagName("fechaotros")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["fechaotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("fechaotros")->item(0)->textContent)));
                                }

                                if (isset($soc->getElementsByTagName("ciiu1")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["ciiu1"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("ciiu1")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("ciiu2")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["ciiu2"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("ciiu2")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("ciiu3")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["ciiu3"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("ciiu3")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("ciiu4")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["ciiu4"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("ciiu4")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("tipositcontrol")->item(0)->textContent)) {
                                    $retorno["vinculos"][$i]["tipositcontrol"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("tipositcontrol")->item(0)->textContent)));
                                }
                    ...
                    if (!empty($socs)) {
                        foreach ($socs as $soc) {
                            if (isset($soc->getElementsByTagName("idtipoidentificacionotros")->item(0)->textContent)) {
                                ...
                                $retorno["vinculosh"][$i]["nombreotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("nombreotros")->item(0)->textContent)));
                                ...
                                if (isset($soc->getElementsByTagName("apellido1otros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["apellido1otros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("apellido1otros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("apellido2otros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["apellido2otros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("apellido2otros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("nombre1otros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["nombre1otros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("nombre1otros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("nombre2otros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["nombre2otros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("nombre2otros")->item(0)->textContent)));
                                }

                                $retorno["vinculosh"][$i]["emailotros"] = '';
                                $retorno["vinculosh"][$i]["celularotros"] = '';
                                if (isset($soc->getElementsByTagName("emailotros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["emailotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("emailotros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("celularotros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["celularotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("celularotros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("idcarotros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["idcargootros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("idcarotros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("cargootros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["cargootros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("cargootros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("vinculootros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["vinculootros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("vinculootros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("cargootros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["cargootros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("cargootros")->item(0)->textContent)));
                                }
                                ...
                                if (isset($soc->getElementsByTagName("numtarpotros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["numtarprofotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("numtarpotros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("idclaseemp")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["idclaseemp"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("idclaseemp")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("numidemp")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["numidemp"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("numidemp")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("idvindian")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["idvindian"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("idvindian")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("cuotasconst")->item(0)->textContent)) {
                                ...
                                if (isset($soc->getElementsByTagName("librootros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["librootros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("librootros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("inscripcionotros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["inscripcionotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("inscripcionotros")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("dupliotros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["dupliotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("dupliotros")->item(0)->textContent)));
                                }

                                if (isset($soc->getElementsByTagName("fechaotros")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["fechaotros"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("fechaotros")->item(0)->textContent)));
                                }

                                if (isset($soc->getElementsByTagName("ciiu1")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["ciiu1"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("ciiu1")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("ciiu2")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["ciiu2"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("ciiu2")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("ciiu3")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["ciiu3"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("ciiu3")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("ciiu4")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["ciiu4"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("ciiu4")->item(0)->textContent)));
                                }
                                if (isset($soc->getElementsByTagName("tipositcontrol")->item(0)->textContent)) {
                                    $retorno["vinculosh"][$i]["tipositcontrol"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("tipositcontrol")->item(0)->textContent)));
                                }
                    ...
                    if (!empty($socs)) {
                        foreach ($socs as $soc) {
                            if (isset($soc->getElementsByTagName("vpidclase")->item(0)->textContent)) {
                                ...
                                $retorno["vincuprop"][$i]["nombre"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("vpnombre")->item(0)->textContent)));
                                $retorno["vincuprop"][$i]["vinculo"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("vpvinculo")->item(0)->textContent)));
                                $retorno["vincuprop"][$i]["cargo"] = (\funcionesGenerales::restaurarEspeciales(trim($soc->getElementsByTagName("vpcargo")->item(0)->textContent)));
                            }
                        }
                    }
                    unset($socs);
                    ...
                    (!isset($reg->getElementsByTagName("cprazsoc")->item(0)->textContent)) ? $retorno["cprazsoc"] = '' : $retorno["cprazsoc"] = (\funcionesGenerales::restaurarEspeciales(trim($reg->getElementsByTagName("cprazsoc")->item(0)->textContent)));
                    ...
                    (!isset($reg->getElementsByTagName("cpdircom")->item(0)->textContent)) ? $retorno["cpdircom"] = '' : $retorno["cpdircom"] = (\funcionesGenerales::restaurarEspeciales(trim(str_replace("#", "Nro.", $reg->getElementsByTagName("cpdircom")->item(0)->textContent))));
                    (!isset($reg->getElementsByTagName("cpdirnot")->item(0)->textContent)) ? $retorno["cpdirnot"] = '' : $retorno["cpdirnot"] = (\funcionesGenerales::restaurarEspeciales(trim(str_replace("#", "Nro.", $reg->getElementsByTagName("cpdirnot")->item(0)->textContent))));
                    ...
                    (!isset($reg->getElementsByTagName("cptirepleg")->item(0)->textContent)) ? $retorno["cptirepleg"] = '' : $retorno["cptirepleg"] = trim($reg->getElementsByTagName("cptirepleg")->item(0)->textContent);
                    (!isset($reg->getElementsByTagName("cpirepleg")->item(0)->textContent)) ? $retorno["cpirepleg"] = '' : $retorno["cpirepleg"] = trim($reg->getElementsByTagName("cpirepleg")->item(0)->textContent);
                    (!isset($reg->getElementsByTagName("cpnrepleg")->item(0)->textContent)) ? $retorno["cpnrepleg"] = '' : $retorno["cpnrepleg"] = trim($reg->getElementsByTagName("cpnrepleg")->item(0)->textContent);
                    (!isset($reg->getElementsByTagName("cptelrepleg")->item(0)->textContent)) ? $retorno["cptelrepleg"] = '' : $retorno["cptelrepleg"] = trim($reg->getElementsByTagName("cptelrepleg")->item(0)->textContent);
                    (!isset($reg->getElementsByTagName("cpemailrepleg")->item(0)->textContent)) ? $retorno["cpemailrepleg"] = '' : $retorno["cpemailrepleg"] = trim($reg->getElementsByTagName("cpemailrepleg")->item(0)->textContent);
    ...
    public static function docToPdf($file_doc, $file_pdf) {
        ...
        \logApi::general2('docToPdf_' . date("Ymd"), '', 'libreoffice --headless --invisible --convert-to pdf:writer_pdf_Export -outdir ' . $_SESSION["generales"]["pathabsoluto"] . '/tmp ' . $file_doc . ' > ' . $ntmp);
    ...
    public static function generarAleatorioNumerico10($dbx, $validar = '', $sinprimercero = 'si') {
        $numrecvalido = 'NO';
        while ($numrecvalido == 'NO') {
            $ok = 'NO';
            while ($ok == 'NO') {
    ...
    public static function retornarUrlSiiCoreProduccion($cc) {
        $salida = '';
        switch ($cc) {
            case "01" : $salida = 'https://siiarmenia.confecamaras.co';
                break;
            case "02" : $salida = 'https://siibarrancabermeja.confecamaras.co';
                break;
            case "06" : $salida = 'https://siibuenaventura.confecamaras.co';
                break;
            case "07" : $salida = 'https://siibuga.confecamaras.co';
                break;
            case "10" : $salida = 'https://siicartago.confecamaras.co';
                break;
            case "11" : $salida = 'https://siicucuta.confecamaras.co';
                break;
            case "12" : $salida = 'https://siichinchina.confecamaras.co';
                break;
            case "13" : $salida = 'https://siiduitama.confecamaras.co';
                break;
            case "14" : $salida = 'https://siigirardot.confecamaras.co';
                break;
            case "15" : $salida = 'https://siihonda.confecamaras.co';
                break;
            case "16" : $salida = 'https://siiibague.confecamaras.co';
                break;
            case "17" : $salida = 'https://siiipiales.confecamaras.co';
                break;
            case "18" : $salida = 'https://siidorada.confecamaras.co';
                break;
            case "19" : $salida = 'https://siimagangue.confecamaras.co';
                break;
            case "20" : $salida = 'https://siimanizales.confecamaras.co';
                break;
            case "22" : $salida = 'https://siimonteria.confecamaras.co';
                break;
            case "23" : $salida = 'https://siineiva.confecamaras.co';
                break;
            case "24" : $salida = 'https://siipalmira.confecamaras.co';
                break;
            case "25" : $salida = 'https://siipamplona.confecamaras.co';
                break;
            case "26" : $salida = 'https://siipasto.confecamaras.co';
                break;
            case "27" : $salida = 'https://siipereira.confecamaras.co';
                break;
            case "28" : $salida = 'https://siicauca.confecamaras.co';
                break;
            case "30" : $salida = 'https://siiguajira.confecamaras.co';
                break;
            case "31" : $salida = 'https://siisanandres.confecamaras.co';
                break;
            case "32" : $salida = 'https://siisantamarta.confecamaras.co';
                break;
            case "33" : $salida = 'https://siisantarosa.confecamaras.co';
                break;
            case "34" : $salida = 'https://siisincelejo.confecamaras.co';
                break;
            case "35" : $salida = 'https://siisogamoso.confecamaras.co';
                break;
            case "36" : $salida = 'https://siitulua.confecamaras.co';
                break;
            case "37" : $salida = 'https://siitumaco.confecamaras.co';
                break;
            case "38" : $salida = 'https://siitunja.confecamaras.co';
                break;
            case "39" : $salida = 'https://siivalledupar.confecamaras.co';
                break;
            case "40" : $salida = 'https://siivillavicencio.confecamaras.co';
                break;
            case "41" : $salida = 'https://siiflorencia.confecamaras.co';
                break;
            case "42" : $salida = 'https://siiamazonas.confecamaras.co';
                break;
            case "43" : $salida = 'https://siisevilla.confecamaras.co';
                break;
            case "44" : $salida = 'https://siiuraba.confecamaras.co';
                break;
            case "45" : $salida = 'https://siisuryorientetolima.confecamaras.co';
                break;
            case "46" : $salida = 'https://siiputumayo.confecamaras.co';
                break;
            case "47" : $salida = 'https://siifacatativa.confecamaras.co';
                break;
            case "48" : $salida = 'https://siiarauca.confecamaras.co';
                break;
            case "49" : $salida = 'https://siiocana.confecamaras.co';
                break;
            case "50" : $salida = 'https://siicasanare.confecamaras.co';
                break;
            case "51" : $salida = 'https://siiorienteantioqueno.confecamaras.co';
                break;
            case "52" : $salida = 'https://siimmedio.confecamaras.co';
                break;
            case "53" : $salida = 'https://siiaguachica.confecamaras.co';
                break;
            case "54" : $salida = 'https://siidosquebradas.confecamaras.co';
                break;
            case "55" : $salida = 'https://siiaburrasur.confecamaras.co';
                break;
            case "56" : $salida = 'https://siipiedemonte.confecamaras.co';
                break;
            case "57" : $salida = 'https://siisanjsoe.confecamaras.co';
                break;
            case "58" : $salida = 'https://siisoacha.confecamaras.co';
                break;
        }
        return $salida;
    }
        ...
        foreach ($tems as $t) {
            if ($t["mostrar"] == 'S') {
                if ($restringirdian == 'si') {
                    if (
                            (trim($t["dian064"]) != '' && $t["dian064"] != '99') ||
                            (trim($t["dian065"]) != '' && $t["dian065"] != '99') ||
                            (trim($t["dian066"]) != '' && $t["dian066"] != '99') ||
                            (trim($t["dian067"]) != '' && $t["dian067"] != '99') ||
                            (trim($t["dian068"]) != '' && $t["dian068"] != '99') ||
                            (trim($t["dian069"]) != '' && $t["dian069"] != '99')) {
     ...
     * 
     * @param type $mysqli
     * @param type $schemabase (base de datos)
     * @param type $campo (tabla.campo)
     * @return bool
     */
