 ...
 * @return type
 */
function armarPdfImagenesApi($dbx,$detalle, $evidencias, $rutaSalida) {
 ...
 */
function generarPdfNotificacionEmailApi($dbx,$tnot = '', $rad = '', $dev = '', $ope = '', $rec = '', $lib = '', $reg = '', $dup = '', $idc = '', $ide = '', $mat = '', $pro = '', $nom = '', $ema = '', $det = '', $fpro = '', $hpro = '', $fnot = '', $hnot = '', $est = '', $obs = '', $bandeja = '', $procesoespecial = '') {
 ...
 * @return boolean 
 */
function generarPdfNotificacionSmsApi($dbx,$cel='', $tip='', $rec='', $cba='', $ins='', $dev='', $exp='', $mat='', $pro='', $ide='', $nom='', $det='', $obs='', $bandeja = '', $procesoespecial='') {
