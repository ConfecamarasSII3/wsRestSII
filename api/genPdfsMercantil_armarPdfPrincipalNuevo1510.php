 ...
 */
function armarPdfPrincipalNuevo1510($dbx = null,$numrec = '', $numliq = 0, $tipoimpresion = '', $prediligenciado = 'no', $txtFirmaElectronica = '') {
    ...
    if ($tipoimpresion != 'vacio') {
        ...
        if (trim($_SESSION ["formulario"] ["datos"] ["ape1"]) == '') {
            ...
            $formulario->armarCampo('p1.raz_soc', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["nombre"]));
            $formulario->armarCampo('p1.sig', $_SESSION ["formulario"] ["datos"] ["sigla"]);
        }

        $formulario->armarCampo('p1.ape1', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["ape1"]));
        $formulario->armarCampo('p1.ape2', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["ape2"]));
        $formulario->armarCampo('p1.nom', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["nom1"] . ' ' . $_SESSION ["formulario"] ["datos"] ["nom2"]));
        ...
        $formulario->armarCampo('p1.dom_dir', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["dircom"]));
        $formulario->armarCampo('p1.dom_mun', \funcionesGenerales::utf8_decode(retornarNombreMunicipioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["muncom"])));
        $formulario->armarCampo('p1.dom_dep', \funcionesGenerales::utf8_decode(retornarNombreDptoMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["muncom"])));
        $formulario->armarCampo('p1.dom_pais', 'COLOMBIA');

        if (ltrim($_SESSION ["formulario"] ["datos"] ["barriocom"], "0") != '') {

            $formulario->armarCampo('p1.dom_bar', retornarNombreBarrioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["muncom"], $_SESSION ["formulario"] ["datos"] ["barriocom"]));
        }
        ...
        $formulario->armarCampo('p1.not_dir', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["dirnot"]));
        $formulario->armarCampo('p1.not_mun', \funcionesGenerales::utf8_decode(retornarNombreMunicipioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["munnot"])));
        $formulario->armarCampo('p1.not_dep', \funcionesGenerales::utf8_decode(retornarNombreDptoMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["munnot"])));
        $formulario->armarCampo('p1.not_pais', 'COLOMBIA');


        if (ltrim($_SESSION ["formulario"] ["datos"] ["barrionot"], "0") != '') {

            $formulario->armarCampo('p1.not_bar', retornarNombreBarrioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["munnot"], $_SESSION ["formulario"] ["datos"] ["barrionot"]));
        }
    ...
    if ($tipoimpresion != 'vacio') {
        ...
        if (($_SESSION ["formulario"] ["datos"] ["organizacion"] == '12') || ($_SESSION ["formulario"] ["datos"] ["organizacion"] == '14')) {
            ...
            if (ltrim($_SESSION ["formulario"] ["datos"] ["vigcontrol"], "0") != '') {
                ...
                $formulario->armarCampo('p2.ent_vig', retornarNombreTablasSirepMysqliApi($dbx,'43', $_SESSION ["formulario"] ["datos"] ["vigcontrol"]));
            }
        }
        ...
        if ($numliq != 0) {
            ...
            if ($_SESSION ["formulario"] ["datos"] ["organizacion"] == '01') {
                ...
                $formulario->armarCampo('p2.firm_nom', \funcionesGenerales::utf8_decode($nombre_completo));
                ...
                if (isset($_SESSION ["formulario"] ["datos"] ["propietarios"])) {
                    if (isset($_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["nombrepropietario"])) {
                        $formulario->armarCampo('p2.firm_nom', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["nombrepropietario"]));
