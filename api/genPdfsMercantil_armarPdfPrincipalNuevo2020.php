 ...
 * @return string
 */
function armarPdfPrincipalNuevo2020Api($dbx = null, $numrec = '', $numliq = 0, $tipoimpresion = '', $prediligenciado = 'no', $txtFirmaElectronica = '', $txtFirmaManuscrita = '', $ideFirmaManuscrita = '', $nomFirmaManuscrita = '', $cambidom = 'no', $anoimprimir = '', $fechaimprimir = '') {
