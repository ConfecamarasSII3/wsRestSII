...
function tamanoS3Version4($path) {
...
function almacenarS3Version4($path, $imagen, $tipo = 'SII') {
    if (substr(PHP_VERSION, 0, 1) == '7') {
        require_once ($_SESSION["generales"]["pathabsoluto"] . '/components74/vendor/autoload.php');
    } else {
        if (substr(PHP_VERSION, 0, 1) == '8') {
...
function recuperarS3Version4($file) {
    if (substr(PHP_VERSION, 0, 1) == '7') {
        require_once ($_SESSION["generales"]["pathabsoluto"] . '/components74/vendor/autoload.php');
    } else {
        if (substr(PHP_VERSION, 0, 1) == '8') {
...
function existenciaS3Version4_2($file) {
    if (substr(PHP_VERSION, 0, 1) == '7') {
        require_once ($_SESSION["generales"]["pathabsoluto"] . '/components74/vendor/autoload.php');
    } else {
        if (substr(PHP_VERSION, 0, 1) == '8') {
...
function existenciaS3Version4($file) {
    if (substr(PHP_VERSION, 0, 1) == '7') {
        require_once ($_SESSION["generales"]["pathabsoluto"] . '/components74/vendor/autoload.php');
    } else {
        if (substr(PHP_VERSION, 0, 1) == '8') {
...
function recuperarS3Version4RUES($file) {
    if (substr(PHP_VERSION, 0, 1) == '7') {
        require_once ($_SESSION["generales"]["pathabsoluto"] . '/components74/vendor/autoload.php');
    } else {
        if (substr(PHP_VERSION, 0, 1) == '8') {
...
function existenciaS3Version4RUES($file) {
    if (substr(PHP_VERSION, 0, 1) == '7') {
        require_once ($_SESSION["generales"]["pathabsoluto"] . '/components74/vendor/autoload.php');
    } else {
        if (substr(PHP_VERSION, 0, 1) == '8') {
...
function obtenerUrlRepositorioS3($file) {
    ...
    //Inicialmente valida que el archivo exista en el repositorio expuesto. 
