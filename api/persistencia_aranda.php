<?php
function peticionArandaAsignarPruebas($tokenAranda, $tck)
{
...
function peticionArandaAsignarEstadoFlujo($tokenAranda, $tck, $estadoFlujo = '')
{
...
function peticionArandaNotas($tokenAranda, $tck, $leyendaVersion = '', $mostrarNotaCliente = 'no')
{
...
function peticionArandaReplicasActividades($tokenAranda, $tck, $textoNota, $mostrarNotaCliente = 'no')
{
...
function peticionArandaConsultar($tokenAranda, $tck)
{
...
function peticionArandaListarCasosFab($tokenAranda)
{
...
function peticionArandaListarCasosArq($tokenAranda)
{
...
function peticionArandaListarCasosQA($tokenAranda)
{
...
function peticionArandaListarCasosQAOK($tokenAranda)
{
    $arrListar = array(
        'Paging' => array(
            'Start' => 1,
...
function solicitarTokenAranda()
{
    require_once '../configuracion/commonAranda.php';
...
function eliminarTokenAranda($tokenAranda)
{
...
function extraerTickets($cadenaTexto)
{
    $re = '/[IM|RF]{2}+[-]{1}+[0-9]{1,8}+[-]{1}+[0-9]{1,8}+[-]{1}+[0-9]{1,8}/';
    preg_match_all($re, $cadenaTexto, $matches, PREG_SET_ORDER, 0);
    return elementosUnicos($matches);
}

function extraerActividades($cadenaTexto)
{
