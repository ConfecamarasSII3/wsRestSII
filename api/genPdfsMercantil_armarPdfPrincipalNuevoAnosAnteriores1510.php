 ...
 */
function armarPdfPrincipalNuevoAnosAnteriores1510($dbx = null, $numrec = '', $numliq = 0, $tipoimpresion = '', $txtFirmaElectronica = '') {
    try {
        ...
        foreach ($_SESSION["formulario"]["datos"]["f"] as $iAno => $fin) {
            ...
            if ($iAno != $_SESSION["formulario"]["datos"]["anodatos"]) {
                ...
                if ($inclu == 'si') {
                    ...
                    if ($_SESSION ["formulario"] ["datos"] ["organizacion"] != '01') {
                        $formularioPersonas->armarCampo('p4.raz_soc', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["nombre"]));
                    } else {
                        if (trim($_SESSION ["formulario"] ["datos"] ["ape1"]) == '') {
                            $formularioPersonas->armarCampo('p4.raz_soc', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["nombre"]));
                        } else {
                            $formularioPersonas->armarCampo('p4.ape1', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["ape1"]));
                            $formularioPersonas->armarCampo('p4.ape2', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["ape2"]));
                            $formularioPersonas->armarCampo('p4.nom', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["nom1"] . ' ' . $_SESSION ["formulario"] ["datos"] ["nom2"]));
                        }
                    }
                    ...
                    if ($_SESSION ["formulario"] ["datos"] ["organizacion"] == '01') {
                        ...
                        $formularioPersonas->armarCampo('p4.firm_nom', \funcionesGenerales::utf8_decode($nombre_completo));
                        ...
                        if (isset($_SESSION ["formulario"] ["datos"] ["propietarios"])) {
                            $formularioPersonas->armarCampo('p4.firm_nom', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["nombrepropietario"]));
                    ...
                    $formularioPersonas->armarCampo('p4.firma_elec', \funcionesGenerales::utf8_decode($txtFirmaElectronica));
                }
            } // fin if
        } // fin foreach
        // cabezote
