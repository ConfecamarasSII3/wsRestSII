            ...
            foreach ($reg as $rg) {
                ...
                if (trim($arrTem[$i]["matricula"]) != '') {
                    ...
                    if ($arrTem[$i]["organizacion"] == '01') {
                        ...
                        $certif["valor"] = retornarRegistroMysqliApi($mysqli, "mreg_servicios", "idservicio='01010101'", "valorservicio");
                        $certificados[] = $certif;
                        $certif = array();
                        ...
                        $certif["valor"] = retornarRegistroMysqliApi($mysqli, "mreg_servicios", "idservicio='01010104'", "valorservicio");
                        $certificados[] = $certif;
                    }
                    ...
                    if ($arrTem[$i]["organizacion"] > '02' && $arrTem[$i]["organizacion"] != '12' && $arrTem[$i]["organizacion"] != '14') {
                        if ($arrTem[$i]["categoria"] == '1') {
                            ...
                            $certif["valor"] = retornarRegistroMysqliApi($mysqli, "mreg_servicios", "idservicio='01010102'", "valorservicio");
                            $certificados[] = $certif;
                            $certif = array();
                            $certif["tipocertificado"] = "CerMat";
                            $certif["descripcioncertificado"] = "Certificado de matrícula mercantil";
                    ...
                    if ($arrTem[$i]["organizacion"] == '12' || $arrTem[$i]["organizacion"] == '14') {
                        if ($arrTem[$i]["categoria"] == '1') {
                            ...
                            $certif["valor"] = retornarRegistroMysqliApi($mysqli, "mreg_servicios", "idservicio='01010301'", "valorservicio");
                            $certificados[] = $certif;
                            $certif = array();
                ...
                if (trim($arrTem[$i]["proponente"]) != '') {
                    if ($arrTem[$i]["estadoproponente"] == '00' || $arrTem[$i]["estadoproponente"] == '02') {
                        ...
                        $certif["valor"] = retornarRegistroMysqliApi($mysqli, "mreg_servicios", "idservicio='01010201'", "valorservicio");
                        $certificados[] = $certif;
                    }
                }
