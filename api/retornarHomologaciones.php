 ...
 * @return type
 */
function retornarHomologacionRuesApi($dbx, $idserv = '') {
    $res = retornarRegistrosMysqliApi($dbx, 'mreg_homologaciones_rue', "cod_rue='" . $idserv . "'");
    return $res;
}
 ...
 * @return string
 */
function homologacionOrganizacionEspecificaRUESApi($org, $clGen, $clEsp, $clEco) {
    $org_rues = '';
    switch (sprintf("%02s", $org)) {
        case '01':
        case '02':
        case '03':
        case '04':
 ...
 * @return string
 */
function homologacionOrganizacionGeneralRUESApi($org, $clEsp, $arrCiiu) {
...
function homologacionOrganizacionEsadlRUESApi($dbx, $clase = '') {
    $res = retornarRegistroMysqliApi($dbx, 'mreg_clase_esadl', "mostrar='S' and id='" . $clase . "'");
    if ($res && !empty($res)) {
 ...
 * @return string
 */
function homologacionMatriculaRUESApi($valorMatricula) {
 ...
 * @return type
 */
function homologacionOrganizacionRUESApi($org, $clGen, $clEsp, $clEco) {
 ...
 * @return string
 */
function homologacionCategoriaRUESApi($org, $cat) {
    if ($org == '01') {
        return '00';
    }
    if ($org == '02') {
 ...
 * @return string
 */
function homologacionSociedadRUESApi($org = '', $clEsp = '', $arrCiiu = array()) {
 ...
 * @return string
 */
function homologacionEstadoMatriculaRUESApi($valorEstado) {
    ...
    $arrEM = array(
        ...
        'II' => '01', // activa para rues
        //Se vuelve a asignar MG=03 solicitud jint 2017-07-05
        'MG' => '04', // pérdida de competencia
        'IG' => '04', // pérdida de competencia
        'MC' => '03', //cancelada
        'IC' => '03', //cancelada
        'MF' => '09',
        'IF' => '09',
 ...
 * @return string
 */
function homologacionTipoIdentificacionRUESApi($valorTipoIde) {
 ...
 * @return string
 */
function homologacionMotivoCancelacionRUESApi($valor) {
 ...
 * @return string
 */
function homologacionEstadoLiquidacionRUESApi($valor) {
 ...
 * @return string
 */
function homologacionCodigoVinculoRUESApi($org, $valor) {
 ...
 * @return string
 */
function homologacionTipoPropietarioRUESApi($valor) {
 ...
 * @return string
 */
function homologacionTipoPagoRUESApi($valor) {
 ...
 * @return string
 */
function homologacionNaturalezaEsadlRUESApi($org, $valor) {
