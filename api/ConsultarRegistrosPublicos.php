...
trait ConsultarRegistrosPublicos {
    ...
    public function consultarEstadisticasDiarias(API $api) {
        ...
        // ********************************************************************** // 
        $cant = contarRegistrosMysqliApi($mysqli, 'mreg_est_inscritos', "fecmatricula='" . $_SESSION["entrada"]["fecha"] . "' and ctrestmatricula IN ('MA','MI','MC','IA','IC','II','AS')");
        $tarjeta = array();
        ...
        // Tarjeta renovados
        // ********************************************************************** // 
        $cant = contarRegistrosMysqliApi($mysqli, 'mreg_est_inscritos', "fecrenovacion='" . $_SESSION["entrada"]["fecha"] . "' and ctrestmatricula IN ('MA','MI','MC','IA','IC','II','AS') and ultanoren='" . substr($_SESSION["entrada"]["fecha"], 0, 4) . "' and fecmatricula < '" . $_SESSION["entrada"]["fecha"] . "'");
        $tarjeta = array();
