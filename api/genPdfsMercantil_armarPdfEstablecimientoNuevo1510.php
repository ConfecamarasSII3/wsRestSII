 ...
 */
function armarPdfEstablecimientoNuevo1510($dbx = null, $numrec = '', $numliq = 0, $tipoimpresion = '', $prediligenciado = 'no', $txtFirmaElectronica = '') {
    ...
    if ($tipoimpresion != 'vacio') {
        ...
        //
        $formulario->armarCampo('p3.nom', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["nombre"]));

        //
        $formulario->armarCampo('p3.dir', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["dircom"]));
        $formulario->armarCampo('p3.pos', '');

        if (ltrim($_SESSION ["formulario"] ["datos"] ["barriocom"], "0") != '') {
            $formulario->armarCampo('p3.bar', retornarNombreBarrioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["muncom"], $_SESSION ["formulario"] ["datos"] ["barriocom"]));
        }

        $formulario->armarCampo('p3.mun', \funcionesGenerales::utf8_decode(retornarNombreMunicipioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["muncom"])));
        $formulario->armarCampo('p3.dep', \funcionesGenerales::utf8_decode(retornarNombreDptoMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["muncom"])));
        ...
        //
        $formulario->armarCampo('p3.not_dir', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["dirnot"]));
        $formulario->armarCampo('p3.not_pos', '');

        if (ltrim($_SESSION ["formulario"] ["datos"] ["barrionot"], "0") != '') {
            $formulario->armarCampo('p3.not_bar', retornarNombreBarrioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["munnot"], $_SESSION ["formulario"] ["datos"] ["barrionot"]));
        }

        $formulario->armarCampo('p3.not_mun', \funcionesGenerales::utf8_decode(retornarNombreMunicipioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["munnot"])));
        $formulario->armarCampo('p3.not_dep', \funcionesGenerales::utf8_decode(retornarNombreDptoMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["munnot"])));
        ...
        if ($_SESSION ["formulario"] ["datos"]["organizacion"] == '02') {
            if (!empty($_SESSION ["formulario"] ["datos"] ["propietarios"])) {
                if (isset($_SESSION ["formulario"] ["datos"] ["propietarios"] [1])) {
                    ...
                    $formulario->armarCampo('p3.prop1_nom', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["nombrepropietario"]));
                    ...
                    $formulario->armarCampo('p3.prop1_dom_dir', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["direccionpropietario"]));
                    $formulario->armarCampo('p3.prop1_dom_mun', \funcionesGenerales::utf8_decode(retornarNombreMunicipioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["municipiopropietario"])));
                    $formulario->armarCampo('p3.prop1_dom_dep', \funcionesGenerales::utf8_decode(retornarNombreDptoMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["municipiopropietario"])));
                    ...
                    $formulario->armarCampo('p3.prop1_not_dir', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["direccionnotpropietario"]));
                    $formulario->armarCampo('p3.prop1_not_mun', \funcionesGenerales::utf8_decode(retornarNombreMunicipioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["municipionotpropietario"])));
                    $formulario->armarCampo('p3.prop1_not_dep', \funcionesGenerales::utf8_decode(retornarNombreDptoMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["municipionotpropietario"])));
                    $formulario->armarCampo('p3.rep1_nom', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["nomreplegpropietario"]));
                ...
                if (isset($_SESSION ["formulario"] ["datos"] ["propietarios"] [2])) {
                    ...
                    $formulario->armarCampo('p3.prop2_nom', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [2] ["nombrepropietario"]));
                    ...
                    $formulario->armarCampo('p3.prop2_dom_dir', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [2] ["direccionpropietario"]));
                    $formulario->armarCampo('p3.prop2_dom_mun', \funcionesGenerales::utf8_decode(retornarNombreMunicipioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["propietarios"] [2] ["municipiopropietario"])));
                    $formulario->armarCampo('p3.prop2_dom_dep', \funcionesGenerales::utf8_decode(retornarNombreDptoMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["propietarios"] [2] ["municipiopropietario"])));
                    ...
                    $formulario->armarCampo('p3.prop2_not_dir', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [2] ["direccionnotpropietario"]));
                    $formulario->armarCampo('p3.prop2_not_mun', \funcionesGenerales::utf8_decode(retornarNombreMunicipioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["propietarios"] [2] ["municipionotpropietario"])));
                    $formulario->armarCampo('p3.prop2_not_dep', \funcionesGenerales::utf8_decode(retornarNombreDptoMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["propietarios"] [2] ["municipionotpropietario"])));
                    $formulario->armarCampo('p3.rep2_nom', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [2] ["nomreplegpropietario"]));
        ...
        if ($_SESSION ["formulario"] ["datos"]["organizacion"] > '02' &&
            ...
            if ($_SESSION ["formulario"] ["datos"] ["cprazsoc"] != '') {
                ...
                $formulario->armarCampo('p3.prop1_nom', \funcionesGenerales::utf8_decode($_SESSION ["formulario"] ["datos"] ["cprazsoc"]));
                ...
                $formulario->armarCampo('p3.prop1_dom_mun', \funcionesGenerales::utf8_decode(retornarNombreMunicipioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["cpcodmun"])));
                $formulario->armarCampo('p3.prop1_dom_dep', \funcionesGenerales::utf8_decode(retornarNombreDptoMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["cpcodmun"])));
                ...
                $formulario->armarCampo('p3.prop1_not_mun', \funcionesGenerales::utf8_decode(retornarNombreMunicipioMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["cpmunnot"])));
                $formulario->armarCampo('p3.prop1_not_dep', \funcionesGenerales::utf8_decode(retornarNombreDptoMysqliApi($dbx,$_SESSION ["formulario"] ["datos"] ["cpmunnot"])));
            }
        }
