 ...
 *
 */
// require_once ($_SESSION["generales"]["pathabsoluto"] . '/components/fpdf182/fpdf_alpha.php');
...
class formularioRues2020Api extends FPDF {
    ...
    private $imagen2 = '/images/sii/formatos/2020/hoja_2.png';
    ...
    function Footer() {
        ...
        if ($this->PageNo() >= 1) {
            ...
            if ($this->getNota() != '') {
                $this->SetY(- 19);
                $this->Cell(180, 10, "Nota: " . $this->getNota(), 0, 0, 'R');
            }
        }
    }
        ...
        switch ($numPagina) {
            ...
            case '2':
                ...
                $p = array(
                    ...
                    'p2.sec8_cod_est_per_jud' => array(83, 151, 0, 9, 2),
                    'p2.sec8_otro_est' => array(98, 151, -2.5, 9, 20),
                    'p2.sec8_num_emp' => array(158, 151, 0.2, 9, 5),
                    'p2.sec8_eas_si' => array(87, 160, -1.9, 9, 1),
                    'p2.sec8_eas_no' => array(98, 160, -1.9, 9, 1),
                    'p2.sec8_eas_num' => array(115, 160, -1.9, 9, 6),
                    'p2.sec8_innov_si' => array(175.8, 160, -1.9, 9, 1),
                    'p2.sec8_innov_no' => array(184.5, 160, -1.9, 9, 1),
                    ...
                    'p2.sec8_can_muj_dir' => array(91, 155, 0.5, 9, 5), //
                    'p2.sec8_can_muj_tot' => array(166, 155, 0.5, 9, 5), //
