 ...
 * @return type
 */
function armarPdfImagenesSii($dbx,$detalle, $evidencias, $rutaSalida) {
    ...
    if (!class_exists('PDFEvidencias')) {
        ...
        class PDFEvidencias extends TCPDF {
            ...
            public function Header() {
                ...
                $this->SetXY(12, 18);
                $this->Cell(200, 4, utf8_decode($this->razonsocial), 0, 0, 'C');
 ...
 */
function generarPdfNotificacionEmailSii($dbx,$tnot = '', $rad = '', $dev = '', $ope = '', $rec = '', $lib = '', $reg = '', $dup = '', $idc = '', $ide = '', $mat = '', $pro = '', $nom = '', $ema = '', $det = '', $fpro = '', $hpro = '', $fnot = '', $hnot = '', $est = '', $obs = '', $bandeja = '', $procesoespecial = ''
) {
    ...
    $txt .= '<strong>Fecha y hora de programación de la notificación : </strong>' . mostrarFechaSii2($fpro) . ' - ' . mostrarHoraSii2($hpro) . '<br>';
    $txt .= '<br>';
    ...
    copy($rutaSalida, '../../../' . PATH_RELATIVO_IMAGES . '/' . $_SESSION["generales"]["codigoempresa"] . '/' . $pathsalida);
    unlink($rutaSalida);
 ...
 * @return boolean
 */
function generarPdfNotificacionSmsSii($dbx,$cel='', $tip='', $rec='', $cba='', $ins='', $dev='', $exp='', $mat='', $pro='', $ide='', $nom='', $det='', $obs='', $bandeja = '', $procesoespecial='') {
    ...
    $txt .= '<strong>Fecha y hora de programación de la notificación : </strong>' . mostrarFechaSii2(date("Ymd")) . ' - ' . mostrarHoraSii2(date("His")) . '<br>';
    $txt .= '<br>';
