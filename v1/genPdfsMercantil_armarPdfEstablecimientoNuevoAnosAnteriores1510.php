 ...
 */
function armarPdfEstablecimientoNuevoAnosAnteriores1510Sii($dbx,$numrec = '', $numliq = 0, $tipoimpresion = '', $txtFirmaElectronica = '') {
    ...
    try {
        ...
        foreach ($_SESSION ["formulario"] ["datos"] ["f"] as $iAno => $fin) {
            ...
            if ($iAno != $_SESSION ["formulario"] ["datos"] ["anodatos"]) {
                ...
                $formularioEst->armarCampo('p5.est_nom', utf8_decode($_SESSION["formulario"]["datos"]["nombre"]));
                ...
                if ($_SESSION ["formulario"] ["datos"]["organizacion"] == '02') {
                    if (!empty($_SESSION ["formulario"] ["datos"] ["propietarios"])) {
                        if (isset($_SESSION ["formulario"] ["datos"] ["propietarios"] [1])) {
                            ...
                            $formularioEst->armarCampo('p5.dv', calcularDvSii2($ide));
                        }
                    }
                }
                ...
                if ($_SESSION ["formulario"] ["datos"]["organizacion"] > '02' &&
                    ...
                    if ($_SESSION ["formulario"] ["datos"] ["cprazsoc"] != '') {
                        $formularioEst->armarCampo('p5.prop_nom', utf8_decode($_SESSION ["formulario"]["datos"]["cprazsoc"]));
                ...
                if ($_SESSION["formulario"]["datos"]["organizacion"] == '02') {
                    if (isset($_SESSION["formulario"]["propietarios"][1])) {
                        ...
                        $formularioEst->armarCampo('p5.prop_nom', utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["nombrepropietario"]));
                        $formularioEst->armarCampo('p5.prop_num_mat', $_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["matriculapropietario"]);
                        ...
                        $formularioEst->armarCampo('p5.firm_nom', utf8_decode($_SESSION ["formulario"] ["datos"] ["propietarios"] [1] ["nombrepropietario"]));
                ...
                $formularioEst->armarCampo('p5.firma_elec', utf8_decode($txtFirmaElectronica));
            }
        }
