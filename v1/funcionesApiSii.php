...
class funcionesApiSii {
    ...
    public static function apiRetornarListaMatriculasRenovar ($idusuario = '', $matriculabase = '', $identificacionbase = '', $procesartodas = '', $url = '') {
        require_once($_SESSION["generales"]["pathabsoluto"] . '/configuracion/common.php');
        require_once($_SESSION["generales"]["pathabsoluto"] . '/configuracion/common' . $_SESSION["generales"]["codigoempresa"] . '.php');
        require_once($_SESSION["generales"]["pathabsoluto"] . '/api/mysqli.php');
        require_once($_SESSION["generales"]["pathabsoluto"] . '/api/log.php');
        ...
        //
        \logApi::general2($nameLog, '', 'Url para consultar anexo : ' . $url . 'retornarListaMatriculasRenovar');
