...
function armarPdfContrasenaSeguraSoloClave($clave, $ide, $nom, $ideemp, $nomemp, $email, $cel, $nommun, $feclet, $ref) {
    ...
    require_once ('../../librerias/funciones/PDFA.class.php');
    ...
    $pdf->SetX(11);
    $pdf->SetFont('Arial', '', 10);
    $pdf->Write(4, utf8_decode('Señor(a)'));
    $pdf->Ln();
    $pdf->Ln();
    $pdf->SetX(11);
    $pdf->SetFont('Arial', '', 10);
    $pdf->Write(4, utf8_decode($nom));
    $pdf->Ln();
    $pdf->SetX(11);
    $pdf->SetFont('Arial', '', 10);
    $pdf->Write(4, utf8_decode('Identificación: ') . $ide);
    $pdf->Ln();
    $pdf->SetX(11);
    $pdf->SetFont('Arial', '', 10);
    $pdf->Write(4, utf8_decode('Email: ') . $email);
    $pdf->Ln();
    $pdf->SetX(11);
    $pdf->SetFont('Arial', '', 10);
    $pdf->Write(4, utf8_decode('Número celular: ') . $cel);
    $pdf->Ln();
    $pdf->Ln();
    $pdf->SetX(11);
    $pdf->SetFont('Arial', '', 10);
    $pdf->Write(4, utf8_decode('Apreciado/a señor/a'));
    $pdf->Ln();
    $pdf->Ln();
    $pdf->Ln();
    ...
    $pdf->SetX(11);
    $pdf->SetFont('Arial', '', 10);
    $pdf->MultiCell(180, 4, utf8_decode($txt), 0, 'J', 0);
    $pdf->Ln();
    $pdf->Ln();
    $pdf->SetX(11);
    ...
    $txt .= utf8_decode('Dirección de registros públicos') . chr(13) . chr(10);
    $txt .= RAZONSOCIAL;
    $pdf->SetX(11);
    $pdf->SetFont('Arial', '', 10);
