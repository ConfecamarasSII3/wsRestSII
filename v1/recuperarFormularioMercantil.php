...
trait recuperarFormularioMercantil {
...
//
        ...
        if ($tipo == 'esadl') {
            ...
            foreach ($arr as $k => $v) {
                $tsel = '';
                if (trim($k) == trim($_SESSION["formulario"]["datos"]["ctresapertgremio"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $v,
            ...
            foreach ($arr as $k => $v) {
                $tsel = '';
                if (trim($k) == trim($_SESSION["formulario"]["datos"]["ctresainfoivc"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $v,
            ...
            foreach ($arr as $k => $v) {
                $tsel = '';
                if (trim($k) == trim($_SESSION["formulario"]["datos"]["ctresaautregistro"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $v,
        ...
        if ($tipo == 'esadl') {
            ...
            foreach ($arr as $k => $v) {
                $tsel = '';
                if (trim($k) == trim($_SESSION["formulario"]["datos"]["ctresacodnat"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $v,
            ...
            foreach ($temx as $tx) {
                $tsel = '';
                if (trim($tx["id"]) == trim($_SESSION["formulario"]["datos"]["claseespesadl"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
            ...
            foreach ($temx as $tx) {
                $tsel = '';
                if (trim($tx["id"]) == trim($_SESSION["formulario"]["datos"]["claseeconsoli"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $tx["descripcion"],
        ...
        if ($tipo == 'esadl') {
            ...
            foreach ($arr as $k => $v) {
                $tsel = '';
                if (trim($k) == trim($_SESSION["formulario"]["datos"]["ctresadiscap"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $v,
            ...
            foreach ($arr as $k => $v) {
                $tsel = '';
                if (trim($k) == trim($_SESSION["formulario"]["datos"]["ctresaetnia"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $v,
            ...
            foreach ($arr as $k => $v) {
                $tsel = '';
                if (trim($k) == trim($_SESSION["formulario"]["datos"]["ctresadespvictreins"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $v,
            ...
            foreach ($arr as $k => $v) {
                $tsel = '';
                if (trim($k) == trim($_SESSION["formulario"]["datos"]["ctresaindgest"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $v,
        ...
        if ($tipo == 'pnat' || $tipo == 'pjur' || $tipo == 'esadl') {
            ...
            foreach ($arr as $k => $v) {
                $tsel = '';
                if (trim($k) == trim($_SESSION["formulario"]["datos"]["cumplerequisitos1780"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $v,
            ...
            foreach ($arr as $k => $v) {
                $tsel = '';
                if (trim($k) == trim($_SESSION["formulario"]["datos"]["cumplerequisitos1780primren"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $v,
        ...
        if ($tipo == 'pnat' || $tipo == 'pjur' || $tipo == 'esadl') {
            ...
            foreach ($arr as $k => $v) {
                $tsel = '';
                if (trim($k) == trim($_SESSION["formulario"]["datos"]["aportantesegsocial"])) {
                    $tsel = 'SI';
                }
                $temp["opc"][] = array(
                    'label' => $v,
