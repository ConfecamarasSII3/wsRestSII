...
trait consultarMultasPonal {
    ...
    public function consultarMultasPonal(API $api) {
        ...
        if (defined('ACTIVAR_CONTROL_MULTAS_PONAL') && (ACTIVAR_CONTROL_MULTAS_PONAL == 'NO' || ACTIVAR_CONTROL_MULTAS_PONAL == 'LOCAL')) {
            $_SESSION["jsonsalida"]["multadovencido"] = "ERROR";
            $_SESSION["jsonsalida"]["mensajeerror"] = 'No está activo la verificación de multas con el servicio web de la policía';
