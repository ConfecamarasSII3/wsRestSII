...
trait consultarRadicadoSaia {

    public function consultarRadicadoSaia(API $api) {
        ...
        if ($resy === false || empty($resy)) {
            ...
            $radicadoTemp['numeoperacion'] = '';
            $radicadoTemp['numerorecibogob'] = '';
            $radicadoTemp['numeoperaciongob'] = '';
        } else {
            ...
            $radicadoTemp['numeoperacion'] = $resy["numeoperacion"];
            $radicadoTemp['numerorecibogob'] = $resy["numerorecibogob"];
            $radicadoTemp['numeoperaciongob'] = $resy["numeoperaciongob"];
        }
