...
trait ConsultarBD {
    ...
    public function retornarRegistro(API $api) {
        ...
        //
        $res = retornarRegistroMysqliApi($mysqli, $_SESSION["entrada"]["tabla"], $_SESSION["entrada"]["query"], $_SESSION["entrada"]["campos"], $_SESSION["entrada"]["tipo"]);
        $mysqli->close();
    ...
    public function retornarRegistros(API $api) {
        ...
        //
        $res = retornarRegistrosMysqliApi($mysqli, $_SESSION["entrada"]["tabla"], $_SESSION["entrada"]["query"], $_SESSION["entrada"]["orden"], $_SESSION["entrada"]["campos"], $_SESSION["entrada"]["offset"], $_SESSION["entrada"]["limit"]);
        $mysqli->close();
    ...
    public function borrarRegistros(API $api) {
        ...
        //
        $res = borrarRegistrosMysqliApi($mysqli, $_SESSION["entrada"]["tabla"], $_SESSION["entrada"]["query"]);
        $mysqli->close();
    ...
    public function regrabarRegistros(API $api) {
        ...
        $res = regrabarRegistrosMysqliApi($mysqli, $_SESSION["entrada"]["tabla"], $arrCampos, $arrValores, $_SESSION["entrada"]["query"]);
        $mysqli->close();
