<?php
if (!function_exists('myErrorHandlerSii')) {
    function myErrorHandlerSii($errno, $errstr, $errfile, $errline)
    {
        ...
        switch ($errno) {
            case E_USER_ERROR:
                ...
                \logSii2::general2('myErrorHandler-' . date("Ymd"), '', utf8_encode($txt));
            ...
            case E_USER_WARNING:
                ...
                $txt .= 'Error en linea ' . $errline . ' en script ' . $errfile . chr(13) . chr(10);
                \logSii2::general2('myErrorHandler_' . date("Ymd"), '', utf8_encode($txt));
                break;
