 ...
 *
 */
require_once ('fpdf153/fpdf_alpha.php');

class formularioRues2017 extends PDF_ImageAlpha {

    // Declaración como variables privadas de las rutas de los formularios creados en formato png
    private $imagen1 = 'formatos/2017/hoja_1.png';
    private $imagen2 = 'formatos/2017/hoja_2.png';
    private $imagen3 = 'formatos/2017/hoja_3.png';
    private $imagen4 = 'formatos/2017/hoja_4.png';
    private $imagen5 = 'formatos/2017/hoja_5.png';
    private $imagen6 = 'formatos/2017/hoja_6.png';
    private $imagen7 = 'formatos/2017/hoja_7.png';
    private $imagen8 = 'formatos/2017/hoja_8.png';
    private $imagen9 = 'formatos/2017/hoja_9.png';
    private $imagen10 = 'formatos/2017/hoja_10.png';
    private $imagen11 = 'formatos/2017/hoja_11.png';
    private $logo = "";
    private $empresa = "";
    private $pagina = "";
    private $indice = "";
    ...
    public function agregarPagina($numPagina, $estado) {
        ...
        if (isset($this->pagina)) {
            ...
            if (!file_exists('logos/logocamara' . $_SESSION["generales"]["codigoempresa"] . '.jpg')) {
                $this->logo = "logos/logocamara" . $_SESSION ['generales'] ['codigoempresa'] . ".jpg";
            } else {
                if (!file_exists('logos/logocamara' . $_SESSION["generales"]["codigoempresa"] . '.gif')) {
                    $this->logo = "logos/logocamara" . $_SESSION ['generales'] ['codigoempresa'] . ".gif";
                }
            }
            // $this->logo = "logos/logocamara" . $_SESSION ['generales'] ['codigoempresa'] . ".jpg";
            ...
            if (file_exists($this->logo)) {
                switch ($this->pagina) {
                    case 1 :
                        $this->Image($this->logo, 22, 18, 15, 15);
                        break;
                    case 2 :
                        $this->Image($this->logo, 22, 18, 15, 15);
                        break;
                    case 3 :
                        $this->Image($this->logo, 20, 18, 15, 15);
                        break;
                    case 4 :
                        $this->Image($this->logo, 22, 20, 15, 15);
                        break;
                    case 5 :
                        $this->Image($this->logo, 20, 26, 15, 15);
                        break;
                    case 6 :
                        $this->Image($this->logo, 20, 24, 15, 15);
                        break;
                    case 7 :
                        $this->Image($this->logo, 22, 24, 15, 15);
                        break;
                    case 8 :
                        $this->Image($this->logo, 22, 28, 15, 15);
                        break;
                    case 9 :
                        $this->Image($this->logo, 22, 34, 15, 15);
                        break;
                    case 10 :
                        $this->Image($this->logo, 22, 26, 15, 15);
                        break;
                    case 11 :
                        $this->Image($this->logo, 22, 26, 15, 15);
                        break;
        ...
        switch ($numPagina) {
            case '1':
                ...
                $p = array(
                    ...
                    'p1.sec1_col1_mat_ins' => array(66, 68, 9, 9, 1),
                    'p1.sec1_col1_ren' => array(66, 72, 9, 9, 1),
                    'p1.sec1_col1_tra_dom' => array(66, 76, 9, 9, 1),
                    'p1.sec1_col1_aju_inf' => array(66, 80, 9, 9, 1),
                    'p1.sec1_col1_num_mat' => array(28.5, 88, 0.28, 9, 10),
                    'p1.sec1_col1_ano_ren' => array(53.5, 93, 0.45, 9, 4),
                    'p1.sec1_col1_cod_org_gen' => array(71, 98, 0.45, 9, 2),
                    'p1.sec1_col1_cod_org_esp' => array(71, 104.5, 0.45, 9, 2),
                    ...
                    'p1.sec2_ape2' => array(102, 122, -2.5, 9, 20),
                    'p1.sec2_nom1' => array(144, 122, -2.5, 9, 12),
                    'p1.sec2_nom2' => array(170, 122, -2.5, 9, 12),
                    ...
                    'p1.sec4_desc_obj_soc' => array(26, 252.7, -2.5, 6, 1000));
            ...
            case '2':
                ...
                $p = array(
                    ...
                    'p2.sec5_act_cor' => array(49.5, 65, -2.5, 7, 17),
                    'p2.sec5_act_no_cor' => array(49.5, 69.5, -2.5, 7, 17),
                    'p2.sec5_act_tot' => array(49.5, 74, -2.5, 7, 17),
                    'p2.sec5_pas_cor' => array(100.5, 64.9, -2.5, 7, 17),
                    'p2.sec5_pas_no_cor' => array(100.5, 69.4, -2.5, 7, 17),
                    'p2.sec5_pas_tot' => array(100.5, 73.9, -2.5, 7, 17),
                    'p2.sec5_pas_net' => array(100.5, 79.2, -2.5, 7, 17),
                    'p2.sec5_pas_pat' => array(100.5, 83.3, -2.5, 7, 17),
                    'p2.sec5_bal_soc' => array(100.5, 88, -2.5, 7, 17),
                    'p2.sec5_ing_act_ord' => array(162, 64.9, -2.5, 7, 17),
                    'p2.sec5_otr_ing' => array(162, 69.4, -2.5, 7, 17),
                    'p2.sec5_cos_ven' => array(162, 73.9, -2.5, 7, 17),
                    'p2.sec5_gas_ope' => array(162, 78.5, -2.5, 7, 17),
                    'p2.sec5_otr_gas' => array(162, 83.3, -2.5, 7, 17),
                    'p2.sec5_gas_imp' => array(162, 88, -2.5, 7, 17),
                    'p2.sec5_uti_ope' => array(162, 92.5, -2.5, 7, 17),
                    'p2.sec5_res_per' => array(162, 97, -2.5, 7, 17),
                    ...
                    'p2.sec5_cap_ext_pub' => array(139.5, 113, -1.9, 9, 3),
                    'p2.sec5_cap_ext_pri' => array(172.5, 113, -1.9, 9, 3),
                    ...
                    'p2.sec8_cod_est_per_jud' => array(83, 152, 0, 9, 2),
                    'p2.sec8_otro_est' => array(98, 152, -2.5, 9, 20),
                    'p2.sec8_num_emp' => array(158, 151.5, 0.2, 9, 5),
                    'p2.sec8_eas_si' => array(87, 158.5, -1.9, 9, 1),
                    'p2.sec8_eas_no' => array(98, 158.5, -1.9, 9, 1),
                    'p2.sec8_eas_num' => array(115, 158.5, -1.9, 9, 6),
                    'p2.sec8_innov_si' => array(175.8, 158.5, -1.9, 9, 1),
                    'p2.sec8_innov_no' => array(184.5, 158.5, -1.9, 9, 1),
                    'p2.sec8_emp_fam_si' => array(85.6, 165.5, 0, 9, 1),
                    'p2.sec8_emp_fam_no' => array(96.6, 165.5, 0, 9, 1),
                    'p2.sec8_por_emp_temp' => array(157.5, 165.5, -2, 9, 6),
            ...
            case '4' :
                ...
                $p = array(
                    ...
                    'p4.f3_uti_net' => array(163, 196, -2.5, 7, 17),
                    //
                    ...
                    'p4.f4_uti_net' => array(163, 237, -2.5, 7, 17),
                    //
                    'p4.firm_nom' => array(18.5, 257, -2, 9, 32),
            ...
            case '10' :
                ...
                $p = array(
                    ...
                    'p10.num_cons_rep' => array(115, 79, 1, 8, 3),
